		...
		<div class="enquiry">
			...
			<div class="enquiry_cont">
				...
				<div class="social_media">
					<ul>
						<li>
							<a href="https://www.facebook.com/profile.php?id=100077887804025" target="_blank">
								<i class="fa fa-facebook-square"></i>
							</a>
						</li>
						<li>
							<a href="https://www.instagram.com/stuadds.tvm/" target="_blank">
			...
			<div class="copy_details">
				<p>StuDPoint 1.0
					<strong> Copyright <i class="fa fa-copyright"></i> 2022 - 2023 All rights reserved.<br> Developed by <a
							href="http://www.stuinnov.com" target="_blank"> <span class="red-text"> STU Innovations Pvt.
								Ltd.</span></a></strong>
				</p>
				<a href="stumoberptermsandconditions.pdf" target="_blank">Terms & conditions</a>
			</div>
			<!-- /.copy_details -->
		</div>
		<!-- /.enquiry -->
